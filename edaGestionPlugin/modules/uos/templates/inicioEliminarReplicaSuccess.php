<div id=container-content>
    <h1 id=header-content >Desinstalar Aplicación</h1>
     <div id="help-content">
    <p>
    ...
    <div id="content"  >
        ...
        <div><form id="FormAltaCentro" name="FormAltaCentro" method="post" action="<?php echo url_for('uos/bajaCentro') ?>" enctype="" >
           <span class="mifieldset">
               <span class="cajaform" >

                        <label for="IdUONueva" id="IdUONueva_lbl">UO en la que se desinstalará la aplicación:</label>
                        <?php echo $widgetUOS->render('IdUONueva');?>

               </span>
               <span class="cajaform" >

                       <span id="texto_aplicacion"  ><?php echo __('Aplicación a desinstalalar:')?></span>
