<?php
    ...
    /**
     * Test class for EdaAplicacionesPeer
     */

    class EdaAplicacionesPeerTest extends PHPUnit_Framework_TestCase {
   ...
   protected function setUp() {
      $this->object = new EdaAplicacionesPeer();
