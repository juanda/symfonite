    ...
    public function testGetEdaUsuario() {
        ...
        if (is_null($object-> getIdPersona()))
        {
            $this->assertNotNull($object->getEdaOrganismos()->getEdaUsuarioss());
              ...
              $this->assertNotNull($object->getSftPersona()->getEdaUsuarioss());
        }
...
/*
$object2 = new SftEmail();
$object2->hasOnlyDefaultValues();
echo "SftEmail()->getIdPersona(): ".$object2->getIdPersona()."\n";
echo "SftEmail()->getEdaUsuario(): ".$object2->getEdaUsuario()."\n";
*/
?>
