 ...
 */
 ...
 class EdaDireccionesTest extends PHPUnit_Framework_TestCase {
    ...
    protected function setUp() {
      $this->object = new SftDireccion();
      $this->tipo_direccion = new SftTipodireccion();
...
*/
    ...
    public function testSave() {
        try
        {
         $object3 = new SftDireccion();
         $tipo_direccion = new SftTipodireccion();
