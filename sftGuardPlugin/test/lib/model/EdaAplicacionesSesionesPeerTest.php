<?php
    ...
    /**
     * Test class for SftAplicacionSesionesPeer
     */

    class SftAplicacionSesionesPeerTest extends PHPUnit_Framework_TestCase {
    ...
    protected function setUp() {
      $this->object = new SftAplicacionSesionPeer();
     ...
     try
        {
           ...
           $object = new SftAplicacionSesion();
