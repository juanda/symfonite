<?php
    ...
    /**
     * Test class for SftConfPersonalPeerTest
     */

    class SftConfPersonalPeerTest extends PHPUnit_Framework_TestCase {
    ...
    protected function setUp() {
      $this->object = new SftConfPersonal();
