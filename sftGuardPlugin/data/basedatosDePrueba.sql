...
--
-- Table structure for table `sft_acceso_ambito`
--

DROP TABLE IF EXISTS `sft_acceso_ambito`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `sft_acceso_ambito` (
...
--
-- Dumping data for table `sft_acceso_ambito`
--

LOCK TABLES `sft_acceso_ambito` WRITE;
/*!40000 ALTER TABLE `sft_acceso_ambito` DISABLE KEYS */;
INSERT INTO `sft_acceso_ambito` VALUES (2,7,NULL,NULL,NULL,'ACTIVO'),(3,8,NULL,NULL,NULL,'ACTIVO'),(4,10,NULL,NULL,NULL,'ACTIVO'),(4,12,NULL,NULL,NULL,'ACTIVO'),(8,1,NULL,NULL,NULL,'ACTIVO'),(8,2,NULL,NULL,NULL,'ACTIVO'),(8,6,NULL,NULL,NULL,'ACTIVO'),(11,4,NULL,NULL,NULL,'ACTIVO'),(12,2,NULL,NULL,NULL,'ACTIVO'),(12,6,NULL,NULL,NULL,'ACTIVO'),(13,5,NULL,NULL,NULL,'ACTIVO'),(13,6,NULL,NULL,NULL,'ACTIVO');
/*!40000 ALTER TABLE `sft_acceso_ambito` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `sft_accesos`
--

DROP TABLE IF EXISTS `sft_accesos`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `sft_accesos` (
...
--
-- Dumping data for table `sft_accesos`
--

LOCK TABLES `sft_accesos` WRITE;
/*!40000 ALTER TABLE `sft_accesos` DISABLE KEYS */;
INSERT INTO `sft_accesos` VALUES (1,1,1,0,NULL,1),(2,1,2,0,NULL,0),(3,2,2,0,NULL,0),(4,2,3,0,NULL,0),(5,2,9,0,NULL,0),(6,3,8,0,NULL,0),(7,3,9,0,NULL,0),(8,3,4,0,NULL,0),(9,4,7,0,NULL,0),(10,4,8,0,NULL,0),(11,4,4,0,NULL,0),(12,5,5,0,NULL,0),(13,6,5,0,NULL,0);
/*!40000 ALTER TABLE `sft_accesos` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `sft_ambitos`
--

DROP TABLE IF EXISTS `sft_ambitos`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `sft_ambitos` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `sft_ambitos`
--

LOCK TABLES `sft_ambitos` WRITE;
/*!40000 ALTER TABLE `sft_ambitos` DISABLE KEYS */;
INSERT INTO `sft_ambitos` VALUES (1,1,2,'pres','ACTIVO'),(2,1,3,'pres2','ACTIVO'),(3,1,2,'moral','ACTIVO'),(4,1,3,'moral','ACTIVO'),(5,1,3,'capi','ACTIVO'),(6,1,3,'bio','ACTIVO'),(7,3,1,'serweb','ACTIVO'),(8,3,1,'serco','ACTIVO'),(9,3,1,'elec','ACTIVO'),(10,2,1,'platedu','ACTIVO'),(11,2,1,'cont','ACTIVO'),(12,2,1,'mens','ACTIVO');
/*!40000 ALTER TABLE `sft_ambitos` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `sft_ambitos_i18n`
--

DROP TABLE IF EXISTS `sft_ambitos_i18n`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `sft_ambitos_i18n` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `sft_ambitos_i18n`
--

LOCK TABLES `sft_ambitos_i18n` WRITE;
/*!40000 ALTER TABLE `sft_ambitos_i18n` DISABLE KEYS */;
INSERT INTO `sft_ambitos_i18n` VALUES (1,'','','en_GB'),(1,'Los presocráticos','','es_ES'),(2,'','','en_GB'),(2,'Los presocráticos','','es_ES'),(3,'','','en_GB'),(3,'La moral en Kant','','es_ES'),(4,'','','en_GB'),(4,'La moral en Kant','','es_ES'),(5,'','','en_GB'),(5,'Iniciación al Capital de Karl Marx','','es_ES'),(6,'','','en_GB'),(6,'Bioética','','es_ES'),(7,'','','en_GB'),(7,'Servidores Web','','es_ES'),(8,'','','en_GB'),(8,'Servidores de correo','','es_ES'),(9,'','','en_GB'),(9,'Electrónica de red','','es_ES'),(10,'','','en_GB'),(10,'Plataforma educativa','','es_ES'),(11,'','','en_GB'),(11,'Programa de contabilidad','','es_ES'),(12,'','','en_GB'),(12,'Mensajería Interna','','es_ES');
/*!40000 ALTER TABLE `sft_ambitos_i18n` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `sft_ambitostipos`
--

DROP TABLE IF EXISTS `sft_ambitostipos`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `sft_ambitostipos` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `nombre` varchar(255) DEFAULT NULL,
  `descripcion` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
--
-- Dumping data for table `sft_ambitostipos`
--

LOCK TABLES `sft_ambitostipos` WRITE;
/*!40000 ALTER TABLE `sft_ambitostipos` DISABLE KEYS */;
INSERT INTO `sft_ambitostipos` VALUES (1,'Cursos',''),(2,'Proyectos',''),(3,'Áreas','');
/*!40000 ALTER TABLE `sft_ambitostipos` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `sft_aplicacion_sesiones`
--

DROP TABLE IF EXISTS `sft_aplicacion_sesiones`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `sft_aplicacion_sesiones` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `sft_aplicacion_sesiones`
--

LOCK TABLES `sft_aplicacion_sesiones` WRITE;
/*!40000 ALTER TABLE `sft_aplicacion_sesiones` DISABLE KEYS */;
INSERT INTO `sft_aplicacion_sesiones` VALUES (1,2,1,'27468401e9f33ee','2011-06-20 09:38:42');
/*!40000 ALTER TABLE `sft_aplicacion_sesiones` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `sft_aplicaciones`
--

DROP TABLE IF EXISTS `sft_aplicaciones`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `sft_aplicaciones` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `codigo` varchar(255) NOT NULL,
...
CREATE TABLE `sft_confpersonales` (
  ...
  KEY `id_perfil` (`id_perfil`),
  KEY `id_ambito` (`id_ambito`),
  CONSTRAINT `sft_confpersonales_FK_1` FOREIGN KEY (`id_usuario`) REFERENCES `sft_usuarios` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
--
-- Dumping data for table `sft_confpersonales`
--

LOCK TABLES `sft_confpersonales` WRITE;
/*!40000 ALTER TABLE `sft_confpersonales` DISABLE KEYS */;
INSERT INTO `sft_confpersonales` VALUES (1,1,1,1,1,NULL),(2,1,2,1,1,NULL),(3,3,5,3,4,6);
/*!40000 ALTER TABLE `sft_confpersonales` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `sft_control_accesos`
--

DROP TABLE IF EXISTS `sft_control_accesos`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `sft_control_accesos` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `sft_control_accesos`
--

LOCK TABLES `sft_control_accesos` WRITE;
/*!40000 ALTER TABLE `sft_control_accesos` DISABLE KEYS */;
INSERT INTO `sft_control_accesos` VALUES (1,NULL,0,NULL,NULL,NULL,'2011-06-20 09:31:08','2011-06-27 12:16:43'),(2,NULL,0,NULL,NULL,NULL,'2011-06-20 09:48:56','2011-06-20 09:48:56'),(3,NULL,0,NULL,NULL,NULL,'2011-06-20 09:49:11','2011-06-27 07:59:21'),(4,NULL,0,NULL,NULL,NULL,'2011-06-20 09:49:23','2011-06-20 09:49:23'),(5,NULL,0,NULL,NULL,NULL,'2011-06-20 09:49:37','2011-06-20 09:49:37'),(6,NULL,0,NULL,NULL,NULL,'2011-06-20 09:49:47','2011-06-20 09:49:47');
/*!40000 ALTER TABLE `sft_control_accesos` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `sft_credenciales`
--

DROP TABLE IF EXISTS `sft_credenciales`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `sft_credenciales` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `id_aplicacion` int(11) NOT NULL,
...
--
-- Dumping data for table `sft_credenciales`
--

LOCK TABLES `sft_credenciales` WRITE;
/*!40000 ALTER TABLE `sft_credenciales` DISABLE KEYS */;
INSERT INTO `sft_credenciales` VALUES (1,1,'GestionSymfonite_ACCESO','Credencial de acceso de la aplicación:GestionSymfonite'),(2,1,'SFTGESTIONPLUGIN_administracion','Administración completa de la aplicación:GestionSymfonite'),(3,1,'SFTGESTIONPLUGIN_administracion_uo','Administración parcial de la aplicación:GestionSymfonite'),(4,2,'catalogacion_ACCESO','Credencial de acceso de la aplicación:catalogacion'),(5,3,'Mensajeria_ACCESO','Credencial de acceso de la aplicación:Mensajeria'),(6,4,'Contabilidad_ACCESO','Credencial de acceso de la aplicación:Contabilidad'),(7,5,'PlatEdu_ACCESO','Credencial de acceso de la aplicación:PlatEdu'),(8,5,'PlatEdu_Docente','Permite usar la funcionalidad de docente de la plataforma educativa.'),(9,5,'PlatEdu_Alumno','Permite usar la funcionalidad de alumno de la plataforma educativa.'),(10,5,'PlatEdu_Admon','Permite usar la funcionalidad de administración de la plataforma educativa.'),(11,5,'PlatEdu_Coord','Permite usar la funcionalidad de coordinación de la plataforma educativa');
/*!40000 ALTER TABLE `sft_credenciales` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `sft_culturas`
--

DROP TABLE IF EXISTS `sft_culturas`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `sft_culturas` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `sft_culturas`
--

LOCK TABLES `sft_culturas` WRITE;
/*!40000 ALTER TABLE `sft_culturas` DISABLE KEYS */;
INSERT INTO `sft_culturas` VALUES (1,'es_ES','Español'),(2,'en_GB','English');
/*!40000 ALTER TABLE `sft_culturas` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `sft_direcciones`
--

DROP TABLE IF EXISTS `sft_direcciones`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `sft_direcciones` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `sft_direcciones`
--

LOCK TABLES `sft_direcciones` WRITE;
/*!40000 ALTER TABLE `sft_direcciones` DISABLE KEYS */;
/*!40000 ALTER TABLE `sft_direcciones` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `sft_emails`
--

DROP TABLE IF EXISTS `sft_emails`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `sft_emails` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `sft_emails`
--

LOCK TABLES `sft_emails` WRITE;
/*!40000 ALTER TABLE `sft_emails` DISABLE KEYS */;
INSERT INTO `sft_emails` VALUES (1,'rosa@luxemburgo.com',1,2,NULL),(2,'',0,NULL,NULL),(3,'',0,NULL,NULL),(4,'',0,NULL,NULL),(5,'',0,NULL,NULL);
/*!40000 ALTER TABLE `sft_emails` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `sft_estadisticas_aplicacion`
--

DROP TABLE IF EXISTS `sft_estadisticas_aplicacion`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `sft_estadisticas_aplicacion` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `id_aplicacion` int(11) NOT NULL,
  `id_usuario` int(11) NOT NULL,
...
--
-- Dumping data for table `sft_estadisticas_aplicacion`
--

LOCK TABLES `sft_estadisticas_aplicacion` WRITE;
/*!40000 ALTER TABLE `sft_estadisticas_aplicacion` DISABLE KEYS */;
INSERT INTO `sft_estadisticas_aplicacion` VALUES (1,1,1,6,'2011-06-20 09:31:32','2011-06-27 12:16:43','Mozilla/5.0 (X11; U; Linux x86_64; es-ES; rv:1.9.2.17) Gecko/20110422 Ubuntu/10.10 (maverick) Firefox/3.6.17','127.0.0.1'),(2,5,3,6,'2011-06-20 11:37:47','2011-06-27 07:59:21','Mozilla/5.0 (X11; U; Linux x86_64; es-ES; rv:1.9.2.17) Gecko/20110422 Ubuntu/10.10 (maverick) Firefox/3.6.17','127.0.0.1');
/*!40000 ALTER TABLE `sft_estadisticas_aplicacion` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `sft_organismos`
--

DROP TABLE IF EXISTS `sft_organismos`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `sft_organismos` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `sft_organismos`
--

LOCK TABLES `sft_organismos` WRITE;
/*!40000 ALTER TABLE `sft_organismos` DISABLE KEYS */;
/*!40000 ALTER TABLE `sft_organismos` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `sft_perfil_credencial`
--

DROP TABLE IF EXISTS `sft_perfil_credencial`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `sft_perfil_credencial` (
  `id_perfil` int(11) NOT NULL,
...
--
-- Dumping data for table `sft_perfil_credencial`
--

LOCK TABLES `sft_perfil_credencial` WRITE;
/*!40000 ALTER TABLE `sft_perfil_credencial` DISABLE KEYS */;
INSERT INTO `sft_perfil_credencial` VALUES (1,1),(1,2),(1,3),(1,4),(1,5),(2,5),(3,5),(4,5),(5,5),(6,5),(7,5),(8,5),(9,5),(9,6),(4,7),(5,7),(6,7),(7,7),(4,8),(5,9),(7,10),(6,11);
/*!40000 ALTER TABLE `sft_perfil_credencial` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `sft_perfiles`
--

DROP TABLE IF EXISTS `sft_perfiles`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `sft_perfiles` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `sft_perfiles_i18n`
--

LOCK TABLES `sft_perfiles_i18n` WRITE;
/*!40000 ALTER TABLE `sft_perfiles_i18n` DISABLE KEYS */;
INSERT INTO `sft_perfiles_i18n` VALUES (1,'SuperAdministrator',NULL,'SuperAdmin','en_GB'),(1,'SuperAdministrador',NULL,'SuperAdmin','es_ES'),(2,'','','','en_GB'),(2,'Sistemas','','','es_ES'),(3,'','','','en_GB'),(3,'Desarrollador','','','es_ES'),(4,'','','','en_GB'),(4,'Profesor','','','es_ES'),(5,'','','','en_GB'),(5,'Alumno','','','es_ES'),(6,'','','','en_GB'),(6,'Coordinador','','','es_ES'),(7,'','','','en_GB'),(7,'Jefe de Estudios','','','es_ES'),(8,'','','','en_GB'),(8,'Secretario','','','es_ES'),(9,'','','','en_GB'),(9,'Contable','','','es_ES');
/*!40000 ALTER TABLE `sft_perfiles_i18n` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `sft_periodos`
--

DROP TABLE IF EXISTS `sft_periodos`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `sft_periodos` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `sft_periodos`
--

LOCK TABLES `sft_periodos` WRITE;
/*!40000 ALTER TABLE `sft_periodos` DISABLE KEYS */;
INSERT INTO `sft_periodos` VALUES (1,1,'2009-01-01',NULL,'UO0','Administración','ACTIVO'),(2,2,'2009-01-01','2009-12-31','PER0','Periodo 1','INACTIVO'),(3,2,'2010-01-01','2010-12-31','PER1','Periodo 2','ACTIVO'),(4,3,'2009-01-01','2009-12-31','PER0','Periodo 1','INACTIVO'),(5,3,'2010-01-01','2010-12-31','PER1','Periodo 2','ACTIVO');
/*!40000 ALTER TABLE `sft_periodos` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `sft_personas`
--

DROP TABLE IF EXISTS `sft_personas`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `sft_personas` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `sft_personas`
--

LOCK TABLES `sft_personas` WRITE;
/*!40000 ALTER TABLE `sft_personas` DISABLE KEYS */;
INSERT INTO `sft_personas` VALUES (1,'Anselmo','Lorenzo','',NULL,'',NULL,'',NULL,'','2011-06-20 09:31:00','2011-06-20 09:31:00',''),(2,'Rosa','Luxemburgo','',NULL,'',NULL,'',NULL,'','2011-06-20 09:48:00','2011-06-20 09:48:00',''),(3,'Carlos','Marx','',NULL,'',NULL,'',NULL,'','2011-06-20 09:49:00','2011-06-20 09:49:00',''),(4,'Federico','Engels','',NULL,'',NULL,'',NULL,'','2011-06-20 09:49:00','2011-06-20 09:49:00',''),(5,'Teresa','Claramount','',NULL,'',NULL,'',NULL,'','2011-06-20 09:49:00','2011-06-20 09:49:00',''),(6,'María','Zambrano','',NULL,'',NULL,'',NULL,'','2011-06-20 09:49:00','2011-06-20 09:49:00','');
/*!40000 ALTER TABLE `sft_personas` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `sft_telefonos`
--

DROP TABLE IF EXISTS `sft_telefonos`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `sft_telefonos` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `sft_telefonos`
--

LOCK TABLES `sft_telefonos` WRITE;
/*!40000 ALTER TABLE `sft_telefonos` DISABLE KEYS */;
/*!40000 ALTER TABLE `sft_telefonos` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `sft_tiposdireccion`
--

DROP TABLE IF EXISTS `sft_tiposdireccion`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `sft_tiposdireccion` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
...
--
-- Dumping data for table `sft_tiposdireccion`
--

LOCK TABLES `sft_tiposdireccion` WRITE;
/*!40000 ALTER TABLE `sft_tiposdireccion` DISABLE KEYS */;
/*!40000 ALTER TABLE `sft_tiposdireccion` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `sft_tiposdireccion_i18n`
--

DROP TABLE IF EXISTS `sft_tiposdireccion_i18n`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `sft_tiposdireccion_i18n` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `sft_tiposdireccion_i18n`
--

LOCK TABLES `sft_tiposdireccion_i18n` WRITE;
/*!40000 ALTER TABLE `sft_tiposdireccion_i18n` DISABLE KEYS */;
/*!40000 ALTER TABLE `sft_tiposdireccion_i18n` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `sft_tiposdocidentificacion`
--

DROP TABLE IF EXISTS `sft_tiposdocidentificacion`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `sft_tiposdocidentificacion` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `sft_tiposdocidentificacion`
--

LOCK TABLES `sft_tiposdocidentificacion` WRITE;
/*!40000 ALTER TABLE `sft_tiposdocidentificacion` DISABLE KEYS */;
/*!40000 ALTER TABLE `sft_tiposdocidentificacion` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `sft_tiposdocidentificacion_i18n`
--

DROP TABLE IF EXISTS `sft_tiposdocidentificacion_i18n`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `sft_tiposdocidentificacion_i18n` (
  `id` int(11) NOT NULL,
  `id_idioma` char(5) NOT NULL,
  `nombre` varchar(24) NOT NULL,
  PRIMARY KEY (`id`,`id_idioma`),
...
--
-- Dumping data for table `sft_tiposdocidentificacion_i18n`
--

LOCK TABLES `sft_tiposdocidentificacion_i18n` WRITE;
/*!40000 ALTER TABLE `sft_tiposdocidentificacion_i18n` DISABLE KEYS */;
/*!40000 ALTER TABLE `sft_tiposdocidentificacion_i18n` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `sft_tiposorganismo`
--

DROP TABLE IF EXISTS `sft_tiposorganismo`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `sft_tiposorganismo` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `sft_tiposorganismo`
--

LOCK TABLES `sft_tiposorganismo` WRITE;
/*!40000 ALTER TABLE `sft_tiposorganismo` DISABLE KEYS */;
/*!40000 ALTER TABLE `sft_tiposorganismo` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `sft_tiposorganismo_i18n`
--

DROP TABLE IF EXISTS `sft_tiposorganismo_i18n`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `sft_tiposorganismo_i18n` (
...
--
-- Dumping data for table `sft_tiposorganismo_i18n`
--

LOCK TABLES `sft_tiposorganismo_i18n` WRITE;
/*!40000 ALTER TABLE `sft_tiposorganismo_i18n` DISABLE KEYS */;
/*!40000 ALTER TABLE `sft_tiposorganismo_i18n` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `sft_tipostelefono`
--

DROP TABLE IF EXISTS `sft_tipostelefono`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Dumping data for table `sft_tipostelefono`
--

LOCK TABLES `sft_tipostelefono` WRITE;
/*!40000 ALTER TABLE `sft_tipostelefono` DISABLE KEYS */;
/*!40000 ALTER TABLE `sft_tipostelefono` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `sft_tipostelefono_i18n`
--

DROP TABLE IF EXISTS `sft_tipostelefono_i18n`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `sft_tipostelefono_i18n` (
  `id` int(11) NOT NULL,
  `id_idioma` char(5) NOT NULL,
...
--
-- Dumping data for table `sft_tipostelefono_i18n`
--

LOCK TABLES `sft_tipostelefono_i18n` WRITE;
/*!40000 ALTER TABLE `sft_tipostelefono_i18n` DISABLE KEYS */;
/*!40000 ALTER TABLE `sft_tipostelefono_i18n` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `sft_uos`
--

DROP TABLE IF EXISTS `sft_uos`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `sft_uos` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `codigo` varchar(20) DEFAULT NULL,
...
--
-- Dumping data for table `sft_uos`
--

LOCK TABLES `sft_uos` WRITE;
/*!40000 ALTER TABLE `sft_uos` DISABLE KEYS */;
INSERT INTO `sft_uos` VALUES (1,'UO0','','gral',NULL,NULL,'2011-06-20 09:31:00','2011-06-20 09:31:00'),(2,'UO1','','gral',NULL,NULL,'2011-06-20 09:54:44','2011-06-20 09:54:44'),(3,'UO2','','gral',NULL,NULL,'2011-06-20 09:54:58','2011-06-20 09:54:58');
/*!40000 ALTER TABLE `sft_uos` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `sft_uos_i18n`
--

DROP TABLE IF EXISTS `sft_uos_i18n`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `sft_uos_i18n` (
  `id` int(11) NOT NULL DEFAULT '0',
  `nombre` varchar(255) DEFAULT NULL,
  `abreviatura` varchar(255) DEFAULT NULL,
...
--
-- Dumping data for table `sft_uos_i18n`
--

LOCK TABLES `sft_uos_i18n` WRITE;
/*!40000 ALTER TABLE `sft_uos_i18n` DISABLE KEYS */;
INSERT INTO `sft_uos_i18n` VALUES (1,'Telematic','','','','en_GB'),(1,'Telemática','','','','es_ES'),(2,'','','','','en_GB'),(2,'Formación','','','','es_ES'),(3,'','','','','en_GB'),(3,'Secretaría','','','','es_ES');
/*!40000 ALTER TABLE `sft_uos_i18n` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `sft_usu_atributos`
--

DROP TABLE IF EXISTS `sft_usu_atributos`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `sft_usu_atributos` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `nombre` varchar(255) NOT NULL,
  `descripcion` varchar(255) DEFAULT NULL,
...
--
-- Dumping data for table `sft_usu_atributos`
--

LOCK TABLES `sft_usu_atributos` WRITE;
/*!40000 ALTER TABLE `sft_usu_atributos` DISABLE KEYS */;
/*!40000 ALTER TABLE `sft_usu_atributos` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `sft_usu_atributos_valores`
--

DROP TABLE IF EXISTS `sft_usu_atributos_valores`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `sft_usu_atributos_valores` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `id_usuario` int(11) DEFAULT NULL,
...
--
-- Dumping data for table `sft_usu_atributos_valores`
--

LOCK TABLES `sft_usu_atributos_valores` WRITE;
/*!40000 ALTER TABLE `sft_usu_atributos_valores` DISABLE KEYS */;
/*!40000 ALTER TABLE `sft_usu_atributos_valores` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `sft_usuarios`
--

DROP TABLE IF EXISTS `sft_usuarios`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `sft_usuarios` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `id_organismo` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `sft_usuarios_U_1` (`alias`),
  KEY `id_persona` (`id_persona`),
