...
function image_themes_tag($source, $options = array())
{
    if (sfConfig::get('app_tema'))
    {
        if (file_exists(sfConfig::get('sf_plugins_dir') . '/themesPlugin/web/themes/' . sfConfig::get('app_tema') . '/' . $source))
        {
            $dir = '../themesPlugin/themes/' . sfConfig::get('app_tema');
        } else
        {
            $dir = '../themesPlugin/themes/default';
        }
    }
...
function use_themes_javascript($js, $position = '', $options = array())
{
    if (sfConfig::get('app_tema'))
    {
        if (file_exists(sfConfig::get('sf_plugins_dir') . '/themesPlugin/web/themes/' . sfConfig::get('app_tema') . '/' . $js))
        {
            $dir = '../themesPlugin/themes/' . sfConfig::get('app_tema');
        } else
        {
...
function use_themes_stylesheet($css, $position = '', $options = array())
{
    if (sfConfig::get('app_tema'))
    {
        if (file_exists(sfConfig::get('sf_plugins_dir') . '/themesPlugin/web/themes/' . sfConfig::get('app_tema') . '/' . $css))
        {
            $dir = '../themesPlugin/themes/' . sfConfig::get('app_tema');
        } else
        {
...
function image_themes_path($source)
{
    if (sfConfig::get('app_tema'))
    {
        if (file_exists(sfConfig::get('sf_plugins_dir') . '/themesPlugin/web/themes/' . sfConfig::get('app_tema') . '/' . $source))
        {
            $dir = sfConfig::get('sf_plugins_dir') . '/themesPlugin/web/themes/' . sfConfig::get('app_tema');
        } else
        {
            $dir = sfConfig::get('sf_plugins_dir') . '/themesPlugin/web/themes/default';
        }
    }
...
function image_themes_url($source, $absolute = false)
{
    if (sfConfig::get('app_tema'))
    {
        if (file_exists(sfConfig::get('sf_plugins_dir') . '/themesPlugin/web/themes/' . sfConfig::get('app_tema') . '/' . $source))
    ...
    return _compute_public_path($source, $dir, 'png', $absolute);
}
