 ...
 * implementa la estructura organizativa.
 *
 ...
 *
 * 2. Normal. Genera una aplicación que se autentifica contra la base de datos
...
EOF;
    ...
    protected function execute($arguments = array(), $options = array())
    {
        ...
        if((!isset($options['es_admin']) ||  $options['es_admin'] != 'true') && !isset($options['clave']))
        {
