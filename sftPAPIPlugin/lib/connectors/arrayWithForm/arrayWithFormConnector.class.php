 ...
 * It's recommended to add them at the 'sft_papi_plugin_connectors' of the file.
 *
 * You can access these parameter by means of the sfConfig::get() function, like
 * this:
 *
 * $param = sfConfig::get('sft_papi_plugin_connectors_array_prueba', 'valor por defecto');
 *
