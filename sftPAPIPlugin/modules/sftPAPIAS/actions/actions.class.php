...
class sftPAPIASActions extends sfActions
{

    public function executeSignin($request)
    {
        $connector_name = sfConfig::get('app_sft_papi_plugin_as_connector', null);
        if (is_null($connector_name))
        {
            throw new Exception('No connector has been defined. You must set sft_papi_plugin_as_connector parameter');
        }
...
//                echo $redirectTo; exit;
        ...
        $this->setLayout(sfConfig::get('app_sft_papi_plugin_as_layout', null));
