...
<?php
$usuario = $SftPersona->dameSftUsuario(ESC_RAW);
...
<td>
    <ul class="sf_admin_td_actions">
        <?php if ($sf_user->hasCredential('SFTGESTIONPLUGIN_administracion')) : ?>
            <?php echo $helper->linkToEdit($SftPersona, array('params' => array(), 'class_suffix' => 'edit', 'label' => 'Edit',)) ?>
            <?php echo $helper->linkToDelete($SftPersona, array('params' => array(), 'confirm' => 'Are you sure?', 'class_suffix' => 'delete', 'label' => 'Delete',)) ?>
        <?php endif; ?>
