<td>
  <ul class="sf_admin_td_actions">
    ...
    <li class="sf_admin_action_asociaperfiles">
      <?php echo link_to(__('Perfiles', array(), 'messages'), 'uo/ListAsociaperfiles?id='.$uo->getId(), array()) ?>
        <?php if($uo -> dameNumeroPerfiles() > 0) : ?>
        (<?php echo $uo -> dameNumeroPerfiles() ?>)
        <?php endif; ?>
    </li>
    <li class="sf_admin_action_asociaperiodos">
      <?php echo link_to(__('Periodos', array(), 'messages'), 'uo/ListAsociaperiodos?id='.$uo->getId(), array()) ?>
