...
<div id="sf_admin_container">
    <h1><?php echo __('Listado de Ámbitos del tipo', array(), 'messages') ?> <i><?php echo $sf_user->getAttribute('ambitotipo'); ?></i></h1>
  ...
  <div id="sf_admin_content">
    ...
    <ul class="sf_admin_actions">
      ...
      <?php include_partial('ambito/list_actions', array('helper' => $helper, 'ambitotipo' => $sf_user->getAttribute('ambitotipo'))) ?>
    </ul>
    </form>
  </div>
