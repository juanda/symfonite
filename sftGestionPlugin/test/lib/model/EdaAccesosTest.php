...
/**
 * Test class for EdaAccesos
 */

 class EdaAccesosTest extends PHPUnit_Framework_TestCase {
    ...
    public function testToString() {
     ...
     $object = new EdaAccesos();
     
     //$alias  = $object->getSftUsuari()->getAlias();
     //$perfil = $object->getSftPerfil()->getDescripcion();
     //$uo     = $object->getSftPerfil()->getSftUo();
