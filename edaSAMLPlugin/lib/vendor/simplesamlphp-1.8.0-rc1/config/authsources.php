...
$yaml_dsn =  sfYaml::load(dirname(__FILE__).'/../../../../../../config/databases.yml');
...
$config = array(
    ...
    'autenticacion_edae3' => array(
        'edae3auth:EDAE3',
        'dsn' => $yaml_dsn['all']['edae3']['param']['dsn'],
        'username' => $yaml_dsn['all']['edae3']['param']['username'],
        'password' => $yaml_dsn['all']['edae3']['param']['password'],
    ),
        /*
          'example' => array(
          'saml:SP',
          'idp' => 'https://libertad/id.provider',
          ),
         */
        /*
          'example-sql' => array(
