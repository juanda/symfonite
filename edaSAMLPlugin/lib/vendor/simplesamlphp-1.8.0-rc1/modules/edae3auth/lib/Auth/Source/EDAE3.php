 ...
 * @version $Id$
 */
class sspmod_edae3auth_Auth_Source_EDAE3 extends sspmod_core_Auth_UserPassBase
{
    ...
    private function connect()
    {
        ...
        {
            throw new Exception('edae3auth:' . $this->authId . ': - Failed to connect to \'' .
    ...
    protected function login($username, $password)
    {
        ...
        if(count($usuario) != 1)
        {
            SimpleSAML_Logger::error('edae3auth:' . $this->authId .
        ...
        {
            throw new Exception('edae3auth:' . $this->authId .
...
";
        ...
        SimpleSAML_Logger::info('edae3auth:' . $this->authId . ': Attributes: ' .
