...
class edaSAMLSesionActions extends BaseedaGestorSesionActions
{
...
//        exit;
        ...
        {
            $this -> getUser()
                    -> setAttribute('id_usuario_from_saml', $saml_attributes['id_sfuser'][0], 'EDAE3User');
...
//            echo '<h1>No implementado aún/Not implemented yet</h1></br>';
//            echo '<h2>Atributos devueltos por el IdP: '. $as -> getAuthData('saml:sp:IdP').'</h2>';
//            echo '<pre>';
//            print_r($this -> saml_attributes);
//            echo '</pre>';
//            exit;
