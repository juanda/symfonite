...
/**
 * Skeleton subclass for representing a row from the 'eda_organismos' table.
 *
 *
 *
 ...
 */
class EdaOrganismos extends BaseEdaOrganismos
{
    ...
    {
        $usuarios =  $this -> getEdaUsuarioss();
        if($usuarios[0] instanceof  EdaUsuarios)
        {
            $c = new Criteria();
            if(!is_null($id_uo))
            {
