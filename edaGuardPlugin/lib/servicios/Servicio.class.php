...
class Servicio
{
    ...
    /**
     *  Devuelve un objeto de propel de tipo EdaUsuarios
    ...
    protected static function dameEdaUsuario($in)
    {
        ...
        switch ($in['tipoId'])
        {
            case 'username':
                ...
                $c -> addJoin(EdaUsuariosPeer::ID_SFUSER, sfGuardUserPeer::ID);
                break;

            case 'alias':
                $c -> add(EdaUsuariosPeer::ALIAS, $in['id']);
                break;

            case 'edaId':
                $c -> add(EdaUsuariosPeer::ID, $in['id']);
                break;
