...
<form name="reinicioPasswordForm" action="<?php echo url_for('@login') ?> " method="post" >
    ...
    <input type="button" onclick="document.reinicioPasswordForm.action='<?php echo url_for('edaGestorSesion/reinicioPassword')?>';document.reinicioPasswordForm.submit()" value="Recuperar Password" />
</form>
    ...
    <div class="sf_admin_form">
        <form name="formLogin" id="formLogin" action="<?php echo url_for('@login') ?> " method="post" >
            ...
            <ul class="sf_admin_actions">
                ...
                <li class="sf_admin_action_list">
                    <input type="button" onclick="document.formLogin.action='<?php echo url_for('edaGestorSesion/reinicioPassword')?>';document.reinicioPasswordForm.submit()" value="Recuperar Password" />
                </li>
            </ul>
        </form>
    </div>
