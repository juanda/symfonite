...
abstract class BasesfGuardUserFormFilter extends BaseFormFilterPropel
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'num_login_fails'               => new sfWidgetFormFilterInput(),
      'token_reset_password'          => new sfWidgetFormFilterInput(),
    ...
    $this->setValidators(array(
      ...
      'num_login_fails'               => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
      'token_reset_password'          => new sfValidatorPass(array('required' => false)),
