...
abstract class BasesfGuardUserForm extends BaseFormPropel
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'num_login_fails'               => new sfWidgetFormInputText(),
      'token_reset_password'          => new sfWidgetFormInputText(),
    ...
    $this->setValidators(array(
      ...
      'num_login_fails'               => new sfValidatorInteger(array('min' => -2147483648, 'max' => 2147483647, 'required' => false)),
      'token_reset_password'          => new sfValidatorString(array('max_length' => 128, 'required' => false)),
