...
abstract class BasesfGuardUser extends BaseObject  implements Persistent {
	...
	/**
	 * The value for the num_login_fails field.
	 * Note: this column has a database default value of: 0
	 * @var        int
	 */
	protected $num_login_fails;

	/**
	 * The value for the token_reset_password field.
	 * @var        string
	 */
	protected $token_reset_password;
	...
	/**
	 * Get the [num_login_fails] column value.
	 * 
	 * @return     int
	 */
	public function getNumLoginFails()
	{
		return $this->num_login_fails;
	}

	/**
	 * Get the [token_reset_password] column value.
	 * 
	 * @return     string
	 */
	...
	/**
	 * Set the value of [num_login_fails] column.
	 * 
	 * @param      int $v new value
	 * @return     sfGuardUser The current object (for fluent API support)
	 */
	public function setNumLoginFails($v)
	{
		if ($v !== null) {
			$v = (int) $v;
		}

		if ($this->num_login_fails !== $v || $this->isNew()) {
			$this->num_login_fails = $v;
			$this->modifiedColumns[] = sfGuardUserPeer::NUM_LOGIN_FAILS;
		}
	...
	/**
	 * Set the value of [token_reset_password] column.
	 * 
	 * @param      string $v new value
	 * @return     sfGuardUser The current object (for fluent API support)
	 */
	public function setTokenResetPassword($v)
	{
		if ($v !== null) {
			$v = (string) $v;
		}

		if ($this->token_reset_password !== $v) {
			$this->token_reset_password = $v;
			$this->modifiedColumns[] = sfGuardUserPeer::TOKEN_RESET_PASSWORD;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->num_login_fails = ($row[$startcol + 9] !== null) ? (int) $row[$startcol + 9] : null;
			$this->token_reset_password = ($row[$startcol + 10] !== null) ? (string) $row[$startcol + 10] : null;
			$this->resetModified();
			...
			return $startcol + 11; // 11 = sfGuardUserPeer::NUM_COLUMNS - sfGuardUserPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function getByPosition($pos)
	{
		switch($pos) {
			...
			case 8:
				...
				break;
			case 9:
				return $this->getNumLoginFails();
				break;
			case 10:
				return $this->getTokenResetPassword();
				break;
			default:
				return null;
				break;
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true)
	{
		...
		$result = array(
			...
			$keys[9] => $this->getNumLoginFails(),
			$keys[10] => $this->getTokenResetPassword(),
		);
		return $result;
	}
	...
	public function setByPosition($pos, $value)
	{
		switch($pos) {
			...
			case 8:
				...
				break;
			case 9:
				$this->setNumLoginFails($value);
				break;
			case 10:
				$this->setTokenResetPassword($value);
				break;
		} // switch()
	}
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[9], $arr)) $this->setNumLoginFails($arr[$keys[9]]);
		if (array_key_exists($keys[10], $arr)) $this->setTokenResetPassword($arr[$keys[10]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(sfGuardUserPeer::NUM_LOGIN_FAILS)) $criteria->add(sfGuardUserPeer::NUM_LOGIN_FAILS, $this->num_login_fails);
		if ($this->isColumnModified(sfGuardUserPeer::TOKEN_RESET_PASSWORD)) $criteria->add(sfGuardUserPeer::TOKEN_RESET_PASSWORD, $this->token_reset_password);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setNumLoginFails($this->num_login_fails);

		$copyObj->setTokenResetPassword($this->token_reset_password);
